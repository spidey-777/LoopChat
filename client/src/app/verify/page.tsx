...
const VerifyPage = () => {
  ...
  const handleSubmit = async (
    ...
    setLoading(true);
    try {
        const {data} = await axios.post(`http://localhost:5050/api/v1/verify`,{
            email,otp:otpString
        })
          alert(data.message)
      ...
      <div className="max-w-md w-full ">
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-8">
              ...
              <div className="flex justify-center in-checked: space-x-3">
                {otp.map((digit, index) => (
                  <input
                    ...
                    className={`w-12 h-12 text-center bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 ${
          ...
          <div className="mt-6 text-center">
            ...
            {timer > 0 ? (
              <p className="text-gray-400 text-sm">Rexend code in {timer} seconds</p>
            ) : (
