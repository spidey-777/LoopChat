                ...
                {isEdit ? (
                  <form onSubmit={submitHandler} className="space-y-4 ">
                    ...
                    <div className="flex gap-2 ">
                      <button
                        type="submit"
                        className="flex gap-2 px-6 py-3 items-center bg-blue-600 hover:bg-blue-700 text-white 
                      ...
                      <button
                        type="button"
                        onClick={editHandler}
                        className="flex gap-2 px-6 py-3 items-center bg-gray-600 hover:bg-gray-700 text-white 
                                        font-semibold rounded-lg"
                      >
                        Cancel
                      </button>
