...
const moveChatToTop = (
  ...
  setChats((prev) => {
    ...
    if (chatIndex !== -1) {
      ...
      const isIncomingMessage = newMessage.sender !== loginUser?._id;
      ...
      const updatedChat = {
        ...
        unseenCount:
          isIncomingMessage && incrementUnseen
            ? (movedChat.unseenCount || 0) + 1
            : movedChat.unseenCount || 0,
      };
...
const resetUnseenCount = (chatId: string) => {
  ...
  useEffect(() => {
    socket?.on("newMessage", (message) => {
      ...
      moveChatToTop(message.chatId, message, selectedUser !== message.chatId);
  ...
  return (
    <div className="min-h-screen flex bg-gray-900 text-white overflow-hidden">
      ...
      <div
        ...
        } w-80 bg-gray-800 border-r border-white/10 fixed md:relative z-30 md:z-auto h-full md:h-auto left-0 top-0`}
      >
        <ChatSideBar
